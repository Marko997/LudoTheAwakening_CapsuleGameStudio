...
public class NetworkRoomPlayerLTA : NetworkBehaviour
{
    [Header("UI")]
    ...
    public void HandleDisplayNameChanged(string olvValue, string newValue) => UpdateDisplay();
    ...
    private void UpdateDisplay()
    {
        ...
        {
            playerNamesTexts[i].text = Room.RoomPlayers[i].DisplayName;
