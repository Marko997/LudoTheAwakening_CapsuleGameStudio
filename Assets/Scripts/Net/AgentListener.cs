...
public class AgentListener : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        UnityNetworkManager.Instance.OnPlayerAdded.AddListener(OnPlayerAdded);
        UnityNetworkManager.Instance.OnPlayerRemoved.AddListener(OnPlayerRemoved);
        ...
        if (portInfo.Count() > 0)
        {
            ...
            UnityNetworkManager.Instance.Port = portInfo.Single().ServerListeningPort;
        }
        else
        {
    ...
    {
        UnityNetworkManager.Instance.StartListen();
    ...
    private void OnShutdown()
    {
        ...
        foreach (var conn in UnityNetworkManager.Instance.Connections)
        {
