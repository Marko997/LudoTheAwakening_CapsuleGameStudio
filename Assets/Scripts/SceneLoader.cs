        ...
        public static void GenerateSceneLoadMenuCode()
        {
            ...
            void AddCodeForDirectory(DirectoryInfo directoryInfo, StringBuilder result1)
            {
                ...
                void AddCodeForFile(FileInfo fileInfo, StringBuilder result2)
                {
                    ...
                    result2.Append("        [MenuItem(\"Scenes/").Append(subPath.Replace(".unity", "")).Append("\")]").Append(Environment.NewLine);
                    result2.Append("        public static void Load").Append(functionName).Append("() { OpenScene(\"").Append(assetPath).Append("\"); }").Append(Environment.NewLine); ;
                }
            }
        }
